...
\],
where $\theta$ is the inertial scheduling function, $\alpha$ is the ``cognitive" component parameter, $\beta$ is the ``social" component parameter, and $\epsilon_1$ and $\epsilon_2$ are random numbers within the range $0..1$ (inclusive).
