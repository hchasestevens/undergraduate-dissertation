...
- Noto et al. (2013) ``Agent-based Social Simulation Model for Analyzing Human Behaviors using Particle Swarm Optimization"
...
- should be noted that the approach used here differs from traditional application of PSO for linguistics modelling, i.e. using PSO directly to model human optimization of language game (as objective function) vs. fine-tuning parameters
...
-possibly, mention that this is coevolutionary (pair responding to changes each other make to objective function) - see if there is any research on this (e.g. franken and engelbrecht 2005)
