...
\begin{equation}
v_i^t = \theta(t) \cdot v_i^{t-1} + \alpha \cdot \epsilon_1 \cdot (x_i^* - x_i^{t-1}) + \beta \cdot \epsilon_2 \cdot (x_{N(i)}^* - x_i^{t-1})
\end{equation}
...
\centering
%\includegraphics[width=\textwidth]{objective_function_cropped.png}
\scalebox{.65}{\input{model_comparison_short.pgf}}
...
\centering
%\includegraphics[width=\textwidth]{objective_function_cropped.png}
\scalebox{.65}{\input{model_errors_short.pgf}}
...
\centering
%\includegraphics[width=\textwidth]{objective_function_cropped.png}
\scalebox{.65}{\input{vary_cost_a.pgf}}
